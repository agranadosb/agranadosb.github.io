let mano_object, antebrazo_object, brazo_object, base_object, pinza_1_object, pinza_2_object, pinza_object
...
function pinza(material) {
    pinza_object = new THREE.Object3D()
    ...
    pinza_object.add(pinza_atras_mesh)
    pinza_object.add(trapezoid_mesh)

    pinza_object.castShadow = true;
    pinza_object.receiveShadow = true;
